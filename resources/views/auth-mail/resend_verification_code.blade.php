...
<body>
    <main
        ...
        <header style="text-align: center;">
            <img src="http://localhost:5173/src/assets/images/logo/paybsix-logo.png" alt="Logo"
        ...
        <footer style="display:flex; width:100%; justify-content:space-between">
            ...
            <div>
                ...
                <a href="https://www.facebook.com/" style="text-decoration: none; color:black">facebook.com/paybsix</a>
            </div>
        </footer>
    </main>
</body>
